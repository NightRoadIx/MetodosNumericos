...
# Lo siguiente es para separar secciones de código usando Hashtashhhh con
# con dos porcentajes
#%%
# Tipos de variables
# No es necesario colocar que tipo de variable como en lenguajes como C-ANSI
# u otros lenguajes que les dicen de tipado fuerte
enteros = 5
...
# y el dato se guarda como un string, esto es extremadamente importante
# pues hay que modificarlo a otro tipo de variable con las funciones del Python
# int(), float()
